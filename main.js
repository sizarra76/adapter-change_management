...
const options = {
  url: 'https://dev66891.service-now.com/',
  username: 'admin',
  password: 'UYIljCp60Irv'
};
...
//|| isHibernating(response)
   ...
   if ((response.statusCode != 200 && response.statusCode != 201)  || error != null  ){
      
      callbackError = 'Error found';
